...
import I18n from 'meteor/timoruetten:react-i18n';
		...
		export default class ModalAddGoal extends Modal {
			...
			renderComponent() {
				let title = ( this.props.stage? <I18n i18nkey='Edit Goal'/>: <I18n i18nkey='Add Goal'/> ),
					content = (
						<div>
							<form ref='form'>
								...
								<div className="form-group" ref='form_group'>
						        	...
						        	<input type="text" className="form-control" ref='title' defaultValue={ this.props.goal.title || ''	}
						        		   name="title" ref='title' autofocus/>
				      			</div>
						      	<div className="form-group">
						        	<label for="title"><I18n i18nkey="Rank (#1 is goal you'd refuse last)"/></label>
						        	<input type="number" className="form-control" name="rank:number" ref='rank' defaultValue = { this.props.goal.rank || ''}/>
						      	</div>

						      	<div className="form-group">
						        	<label for="title"><I18n i18nkey='Progress'/></label>
						        	<input type="number" className="form-control" name="progress:number" 
		        						   id="progress" min="0" max="100" ref='progress' defaultValue={ this.props.goal.progress || 0 }/>
						      	</div>
